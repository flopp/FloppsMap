...
<html>
  <head>
    ...
    <script type="text/javascript" src="js/map-test.js"></script>
...
<span class="add-on" style="width: 48px">Abstand</span>
...
<label class="checkbox" title="Deutsche Naturschutzgebiete in der Karte markieren">
    ...
    <input class="btn btn-info" onClick="javascript:" value="Permalink" id='showPermalink'>
</form>
<b>Externe Links</b>
<ul>
